...
$sql = "SELECT booking.booking_id,booking.package_id,tourpackages.name,booking.fromDate,booking.toDate,booking.NoOfPassesngers,booking.TotalPrice from booking join tourpackages on tourpackages.package_id=booking.package_id where email=$email";
...
<td><a href="package-details.php?pkgid=<?php echo htmlentities($row['package_id']);?>"><?php echo htmlentities($row['packagename']);?></a></td>
