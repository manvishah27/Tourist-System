...
<div class="selectroom_top" id="payment_form">
            ...
            <form method="post" class="form-wrap" action="Paytm/PaytmKit/pgRedirect.php">
               <!-- <label class="inputLabel">ORDER_ID::*</label> -->
                ...
                <input id="PKG_ID" class="form-control" tabindex="2" maxlength="12" size="12" name="Hotel_ID" autocomplete="off" value="<?php echo $hid ?>" required><br>
                ...
                <input id="TXN_AMOUNT" class="form-control" title="TXN_AMOUNT" tabindex="10" type="number" name="TXN_AMOUNT" value="<?php echo $totalPrice ?>" readonly=""><br>
